angular.module('UsersApp', [])
  .controller('UsersController', function($scope, $http, $interval, $timeout, $window) {
    ...
    users.SetDayOverDayDataset = function(dayOverDayObject) {
      ...
      $scope.data.datasets[2].data = dayDataSet.slice(14,21);
      $scope.data.datasets[3].data = dayDataSet.slice(22,28);
      $scope.data.datasets[4].data = dayDataSet.slice(29,35);
